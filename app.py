...
def cambiar_contraseña():
    ...
    if request.method == 'POST':
        ...
        cursor = conn.cursor()
        cursor.execute("UPDATE Login SET contraseña = %s WHERE correo = %s", (nueva, correo))
        conn.commit()
        conn.close()
...
def mostrar_usuarios():
    ...
    return render_template('usuarios/usuarios.html', usuario=session['usuario'], usuarios=usuarios)
...
def crear_usuario():
    ...
    if not correo or not contraseña:
        return render_template('usuarios/nuevoUsuario.html', error="Correo y contraseña son obligatorios", usuario=session['usuario'])
...
def mostrar_clientes():
    ...
    return render_template('clientes/clientes.html', usuario=session['usuario'], clientes=clientes)
...
def crear_cliente():
    ...
    if not (nombre and direccion and telefono and correo):
        return render_template('clientes/nuevoCliente.html', error="Todos los campos son obligatorios", usuario=session['usuario'])
...
def mostrar_insumos():
    ...
    return render_template('insumos/insumos.html', usuario=session['usuario'], insumos=insumos, proveedores=proveedores)
...
def nuevo_insumo():
    ...
    return render_template('insumos/nuevoInsumo.html', proveedores=proveedores, usuario=session['usuario'])
...
def crear_insumo():
    ...
    if not (descripcion and tipo and precio_unitario and id_proveedor):
        ...
        return render_template('insumos/nuevoInsumo.html', error=error, proveedores=proveedores, usuario=session['usuario'])
...
def nuevo_proveedor():
    ...
    return render_template('proveedores/nuevoProveedor.html', usuario=session['usuario'])
...
def crear_proveedor():
    ...
    if not (nombre and direccion and telefono and correo):
        return render_template('proveedores/nuevoProveedor.html', error="Todos los campos son obligatorios", usuario=session['usuario'])
...
def mostrar_maquinas():
    ...
    return render_template('maquinas/maquinas.html',
                           usuario=session['usuario'],
                           maquinas=maquinas,
                           clientes=clientes,
                           es_admin=es_admin)
...
def nueva_maquina():
    ...
    return render_template('maquinas/nuevaMaquina.html', usuario=session['usuario'], clientes=clientes)
...
def crear_maquina():
    ...
    if not (modelo and id_cliente and ubicacion_cliente and costo_alquiler_mensual):
        ...
        clientes = cursor.fetchall()
        conn.close()
        return render_template('maquinas/nuevaMaquina.html', error=error, clientes=clientes, usuario=session['usuario'])
...
def mostrar_tecnicos():
    ...
    return render_template('tecnicos/tecnicos.html',
                           usuario=session['usuario'],
                           tecnicos=tecnicos,
                           es_admin=es_admin)
...
def crear_tecnico():
    ...
    if not (ci and nombre and apellido and telefono):
        return render_template('tecnicos/nuevoTecnico.html', error="Todos los campos son obligatorios.", usuario=session['usuario'])
...
def mostrar_consumos():
    ...
    return render_template('consumos/consumos.html', usuario=session['usuario'], consumos=consumos)
...
def nuevo_consumo():
    ...
    return render_template('consumos/nuevoConsumo.html',
                           usuario=session['usuario'],
                           maquinas=maquinas,
                           insumos=insumos)
...
def mostrar_mantenimientos():
    ...
    return render_template('mantenimientos/mantenimientos.html', usuario=session['usuario'], mantenimientos=mantenimientos)
...
def nuevo_mantenimiento():
    ...
    return render_template('mantenimientos/nuevoMantenimiento.html', usuario=session['usuario'], maquinas=maquinas, tecnicos=tecnicos)
